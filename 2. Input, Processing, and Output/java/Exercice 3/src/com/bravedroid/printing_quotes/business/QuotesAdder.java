...
public class QuotesAdder {
    ...
    public String addQuotes(String quotesText, String quotesAuthor) {
    ...
    public void saveQuotes(String quoteToSave) throws IOException {
        //deligate the work to the responsible (repository)
        repository.storeQuote(quoteToSave);
    }
}
